...
<head>
    ...
    <title>@yield('title') | Dellasta Informática</title>
    ...
    <link rel="stylesheet" href={{asset("static/dist/css/skins/skin-blue.min.css")}}>
    <!-- DataTables -->
...
<div class="wrapper">
    ...
    <!-- Main Header -->
    @include('admin.core.header_nav')
    <!-- Left side column. contains the logo and sidebar -->
    @include('admin.core.aside_left')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                @yield('title_page')
                <small>@yield('opcional_page_descriptions')</small>
            </h1>
            <ol class="breadcrumb">
    ...
    <footer class="main-footer">
        ...
        <div class="pull-right hidden-xs">
            Desenv. <a href="#">Jeferson Mainini</a>
        </div>
        <!-- Default to the left -->
        <strong>Copyright &copy; {{date('Y')}} <a href="#">Dellasta Informática</a>.</strong> Todos os Direitos Reservados.
    </footer>

    <!-- Control Sidebar -->
    @include('admin.core.aside_right')
    <!-- /.control-sidebar -->
